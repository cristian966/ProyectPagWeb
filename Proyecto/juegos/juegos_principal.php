...
<body class="fondo">
    ...
    <div id="barrabuscar" class="barrabuscarcl">
		<form method="POST">
		<input type="submit" value="Buscar" name="btnbuscar"><input type="text" class="buscar" name="txtbuscar" id="cajabuscar" placeholder="&#128270;Buscar Juego">
		</form>
    </div>
    ...
    <div class="divPadre">
        ...
        <div class="contenedor1">
            <div class="titulo">
                <h1 class="titulo1">Información general del videojuego</h1>
            </div>
            <!-- Agregar juegos -->
    <?php
           ...
           {
               $queryusuarios = mysqli_query($conn, "SELECT nombre, id_juego, foto FROM juego ORDER BY id_juego DESC");
           }
        ...
        <div class="ancho">
            <h3>Páginas</h3>
                <span>
                    ...
                    <a class='enlaceperfil' href="juegos_principal.php">Juegos</a> <br>
