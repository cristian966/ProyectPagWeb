...
<body class="fondo">
    ...
    <div id="barrabuscar" class="barrabuscarcl">
		<form method="POST">
		<input type="submit" value="Buscar" name="btnbuscar"><input type="text" class="buscar" name="txtbuscar" id="cajabuscar" placeholder="&#128270;Buscar Noticia">
		</form>
    </div>
    ...
    <div class="divPadre">
        ...
        <div class="contenedor1">
           ...
           {
               $queryusuarios = mysqli_query($conn, "SELECT titulo, id_noticias, img FROM noticia ORDER BY id_noticias DESC");
           }
        ...
        <div class="ancho">
            <h3>Páginas</h3>
                <span>
                    ...
                    <a class='enlaceperfil' href="noticias_principal.php">Noticias</a><br>
