...
<body class="fondo">
    ...
    <div id="barrabuscar" class="barrabuscarcl">
		<form method="POST">
		<input type="submit" value="Buscar" name="btnbuscar"><input type="text" class="buscar" name="txtbuscar" id="cajabuscar" placeholder="&#128270;Buscar Review">
		</form>
    </div>
    ...
    <div class="divPadre">
        ...
        <div class="contenedor1">
            <div class="titulo">
                <h1 class="titulo1">Reviews de Videojuegos</h1>
            </div>
            <!-- Agregar reviews -->
            <?php
            ...
            {
                $queryusuarios = mysqli_query($conn, "SELECT titulo, id_review, img FROM review ORDER BY id_review DESC");
            }
        ...
        <div class="ancho">
            <h3>Páginas</h3>
                <span>
                    ...
                    <a class='enlaceperfil' href="reviews_principal.php">Reviews</a><br>
