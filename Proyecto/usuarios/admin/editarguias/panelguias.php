...
$queryusuarios = mysqli_query($conn, "SELECT id_guia,titulo,texto_guia,img FROM guia where titulo like '".$buscar."%'");
}
else
{
  ...
  <form action="./controlguias/agregar.php" class="contenedor_popup" method="POST">
		...
		<tr><th colspan="2">Nuevo Juego</th></tr>
            ...
            <tr> 
                <td>Texto guia</td>
                <td>
                    <textarea name="txtguia" id="" cols="40" rows="20" required></textarea>
                    <!--<input type="textarea" name="txtguia" required>-->
                </td>
            </tr>
            <tr> 
                <td>Img</td>
